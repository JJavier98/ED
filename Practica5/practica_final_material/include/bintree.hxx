...
/*
    Iterador para recorrido en Preorden
*/
...
/*
    Iterador para recorrido en Inorden
*/
...
/*
    Iterador para recorrido en Postorden
*/
...
template <typename T>
inline 
bintree<T>::const_preorder_iterator::const_preorder_iterator(bintree<T>::node n) : elnodo(n)
{
}
