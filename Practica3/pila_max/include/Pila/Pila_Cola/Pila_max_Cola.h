/**
  * @file Pila_max_VD.h
  * @brief Fichero cabecera del TDA Pila_Max implementado con Cola
  *
  */
#ifndef _PILA_COLA_
#define _PILA_COLA_
...
/**
  *  @brief T.D.A. Pila_Max (Cola)
  *
  * Una instancia @e p del tipo de datos abstracto @c Pila_Max es un objeto
  * que contiene una lista de enteros acompañados del máximo valor introducido hasta el momento implementada en una Cola.
...
class Pila_Max{
private:
	Cola<interior_pila> pila;	///< Contenedor usado como pila(T.D.A. Cola)
